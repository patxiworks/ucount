# Generated by Django 5.0.3 on 2024-12-24 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('othername', models.CharField(blank=True, db_column='OtherName', default='', max_length=30, null=True, verbose_name='Other name(s)')),
                ...
                ('email', models.EmailField(db_column='Email', max_length=150, validators=[django.core.validators.EmailValidator()], verbose_name='Email address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activitydate', models.DateTimeField(db_column='ActivityDate', verbose_name='Date')),
                ('activityenddate', models.DateTimeField(blank=True, db_column='ActivityEndDate', null=True, verbose_name='End Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('placeholderid', models.AutoField(db_column='PlaceholderID', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entrydate', models.DateTimeField(blank=True, db_column='EntryDate', default=django.utils.timezone.now)),
                ...
                ('entryuser', models.ForeignKey(blank=True, db_column='EnteredBy', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Entered by')),
                ('person', models.ForeignKey(blank=True, db_column='PersonID', null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.e1people', verbose_name='Person')),
                ('placeholder', models.ForeignKey(blank=True, db_column='PlaceholderID', null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.userplaceholders')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.IntegerField(choices=[(0, 0), (1, 1), (2, 2), (3, 3)], db_column='Level', default=0)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('placeholder', None)), fields=('activitieslogid', 'person'), name='unique_with_person'),
        ),
        migrations.AddConstraint(
            model_name='r2participants',
