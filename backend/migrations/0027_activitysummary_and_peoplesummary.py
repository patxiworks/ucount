...
P2.Surname ||', '|| P2.FirstName AS ParticipantFriend
FROM e1_people P1
JOIN
	(SELECT *, 
		RANK() OVER (PARTITION BY PersonID ORDER BY StartDate DESC) date_rank 
...
"""
DROP_SQL_people = "DROP VIEW IF EXISTS people_summary;"


class Migration(migrations.Migration):

    dependencies = [
        ('backend', '0026_activitysummary_and_activityid_and_addpartition_more'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql=CREATE_SQL_people,
            reverse_sql=DROP_SQL_people,
        ),
    ]
